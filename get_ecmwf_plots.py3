...
targetDirBase = '/home/disk/bob/s2noclime/model/ecmwf'
products = {'mslp_pcpn_wus':{'suffix':'prate_mslp','has_anal_prod':0},
            ...
            'temp_adv_fgen_700_wus':{'suffix':'700hPa_temp_adv_fgen_wind','has_anal_prod':1},
            'temp_adv_fgen_850_wus':{'suffix':'850hPa_temp_adv_fgen_wind','has_anal_prod':1}}
tempDir = '/tmp'
            ...
            for idx,urlFileName in enumerate(urlFileList,0):
                ...
                if urlFileName not in localFileList:
                    ...
                    try:
                        ...
                        command = 'wget --referer="https://www.tropicaltidbits.com" --user-agent="Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36" '+ecmwfUrl+'/'+currentModelRun+'/'+urlFileName
                        os.system(command)
